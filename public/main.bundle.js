...
module.exports = "<input [(ngModel)]=\"message\" />\n<button (click)=\"sendMessage()\">Send</button>\n\n\n<input type=\"file\" ng2FileSelect [uploader]=\"subeArchivos\" />\n\n<button type=\"button\" class=\"btn btn-success btn-s\"\n(click)=\"subeArchivos.uploadAll()\" >Upload all\n</button>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(chatService) {
        ...
        this.title = 'app';
        this.subeArchivos = new __WEBPACK_IMPORTED_MODULE_2_ng2_file_upload__["FileUploader"]({ url: "http://localhost:3000/upload" });
    }
    AppComponent.prototype.sendMessage = function () {
        this.chatService.sendMessage(this.message);
        this.message = '';
    };
    AppComponent.prototype.ngOnInid = function () {
        this.chatService
            .getMessages()
